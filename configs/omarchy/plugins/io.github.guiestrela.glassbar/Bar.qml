...
Item {
  ...
  component BarPanel: PanelWindow {
    ...
    margins {
      top: root.barHidden && root.position === "top" ? -root.barSize : (root.position === "bottom" ? 0 : 8)
      bottom: root.barHidden && root.position === "bottom" ? -root.barSize : (root.position === "top" ? 0 : 8)
      left: root.barHidden && root.position === "left" ? -root.barSize : (root.position === "right" ? 0 : 8)
      right: root.barHidden && root.position === "right" ? -root.barSize : (root.position === "left" ? 0 : 8)
    }
